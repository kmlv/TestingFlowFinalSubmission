...
\begin{frame}{Transaction Price Dynamics}
    \begin{figure}[H]
        \centering
...
\begin{table}[!htbp]
    ...
    \hline
    \hline \\[-1.8ex]
     Average Price                  & 8.62      & 9.37      & 9.04      & 9.57      & 8.21      & 9.18      \\
     \hspace{3mm}(std.)             & (2.77)    & (2.54)    & (2.95)    & (2.75)    & (2.51)    & (2.29)    \\
    $\mid P^W_t - P_{CE}\mid$        & 2.16      & 2.08      & 2.19      & 2.32      & 2.14      & 1.84      \\
     $\mid P^W_{t} - P^W_{t - 1}\mid$   & 0.57      & 0.39      & 0.58      & 0.39      & 0.55      & 0.4       \\
     Std($\ln P^W_{t} - \ln P^W_{t - 1}$)  & 0.14      & 0.07      & 0.15      & 0.07      & 0.13      & 0.07      \\     
    \hline
    \hline 
    \end{tabular}
...
To assess the impact of format on market performance, we estimate: 
...
indexed by group (i.e., session) and time, 
and the coefficient $\gamma$ 
for the dummy variable $\text{FLOW}_{g,t}$ is the estimated treatment effect. %\pause
...
\begin{frame}{Regression Results: Prices}
\begin{table}[!htbp]
    \centering
    ...
    \\[-1.8ex]\hline
    \hline \\[-1.8ex]
    & \multicolumn{2}{c}{$\mid P^W_t - P_{CE}\mid$} & \multicolumn{2}{c}{$\mid P^W_{t} - P^W_{t - 1}\mid$} & \multicolumn{2}{c}{Std\left(\ln P^W_{t} - \ln P^W_{t - 1}\right)} \\
    & \cline{1-6}
    & (1) & (2) & (3) & (4) & (5) & (6) \\
    & T1-T20 & T11-T20 & T1-T20 & T11-T20 & T1-T20 & T11-T20 \\
    \hline \\[-1.8ex]
     Intercept & 7.813$^{***}$ & 7.970$^{***}$ & 2.456$^{***}$ & 2.924$^{***}$ & 0.345$^{***}$ & 0.391$^{***}$ \\
      & (0.840) & (0.997) & (0.462) & (0.905) & (0.069) & (0.124) \\
     FLOW & -0.116$^{}$ & -0.191$^{}$ & -0.736$^{***}$ & -0.552$^{***}$ & -0.070$^{***}$ & -0.061$^{***}$ \\
      & (0.218) & (0.328) & (0.119) & (0.146) & (0.016) & (0.023) \\
     round & -0.228$^{***}$ & -0.234$^{***}$ & -0.062$^{***}$ & -0.094$^{**}$ & -0.010$^{***}$ & -0.013$^{*}$ \\
      & (0.052) & (0.065) & (0.024) & (0.044) & (0.004) & (0.007) \\
    \hline \\[-1.8ex]
     CDA mean & 2.16 & 2.14 & 0.57 & 0.55 & 0.14 & 0.13 \\
     Observations & 4,800 & 2,400 & 4,600 & 2,300 & 200 & 100 \\
     % $R^2$ & 0.318 & 0.447 & 0.140 & 0.120 & 0.328 & 0.311 \\
     Adjusted $R^2$ & 0.317 & 0.446 & 0.139 & 0.118 & 0.307 & 0.282 \\
    \hline
    \hline \\[-1.8ex]
    \end{tabular}
    \begin{tablenotes}
...
\begin{table}[!htbp]
    ...
    \hline
    \hline \\[-1.8ex]
     Traded Volume                  & 1138      & 959       & 1097      & 872       & 1179      & 1046      \\
     Traded/CE Quantity (\%)        & 93.6      & 78.8      & 90.3      & 71.1      & 96.9      & 86.4      \\
     Filled CE Quantity (\%)        & 85.2      & 77.1      & 81.0      & 69.8      & 89.3      & 84.5      \\
     \#Orders                       & 32       & 24            & 31       & 25            & 32        & 23            \\
     % \hspace{3mm}Seller             & 17       & 12            & 17       & 13            & 17        & 11            \\
     % \hspace{3mm}Buyer              & 15       & 12            & 15       & 12            & 15        & 12            \\
     % Order Size                     & 42       & 72            & 44       & 63            & 40        & 80            \\
     Order Quantity                 & 113      & 182           & 115      & 180           & 111       & 185           \\
     ...
     % \hspace{3mm}Buyer              &           & 20.15         &           & 17.93         &           & 22.37         \\
      Clearing Rate                  &           & 9.37      &           & 9.54      &           & 9.2       \\
     \hspace{3mm}(std.)             &           & (2.6)     &           & (2.8)     &           & (2.4)     \\
     Mean Transaction Size          & 78        &           & 82        &           & 74        &           \\
     \hspace{3mm}(std.)             & (61)      &           & (61)      &           & (60)      &           \\
     \#Transactions                 & 14        &           & 13        &           & 15        &           \\
    % \hline
    % \hline 
    \end{tabular}
    % \begin{tablenotes}
...
\begin{table}[!htbp]
    ...
    \\[-1.8ex]\hline
    \hline \\[-1.8ex]
    & \multicolumn{2}{c}{order number} & \multicolumn{2}{c}{order size} & \multicolumn{2}{c}{traded volume} \\
    & \cline{1-6}
    & (1) & (2) & (3) & (4) & (5) & (6) \\
    & T1-T20 & T11-T20 & T1-T20 & T11-T20 & T1-T20 & T11-T20 \\
    \hline \\[-1.8ex]
     Intercept & 36.170$^{***}$ & 41.770$^{***}$ & 29.481$^{*}$ & 15.523$^{}$ & 746.583$^{***}$ & 728.025$^{***}$ \\
      & (4.702) & (6.710) & (15.726) & (23.527) & (116.483) & (134.216) \\
     FLOW & -7.840$^{***}$ & -8.820$^{***}$ & 10.314$^{*}$ & 17.437$^{***}$ & -178.764$^{***}$ & -132.314$^{**}$ \\
      & (1.512) & (0.827) & (5.319) & (4.700) & (34.432) & (63.499) \\
     round & -0.300$^{}$ & -0.576$^{*}$ & 2.384$^{***}$ & 2.946$^{**}$ & 18.866$^{***}$ & 18.613$^{**}$ \\
      & (0.219) & (0.347) & (0.805) & (1.296) & (6.030) & (7.868) \\
    \hline \\[-1.8ex]
     CDA & 32 & 32 & 42 & 40 & 1138 & 1179 \\
     Observations & 200 & 100 & 200 & 100 & 200 & 100 \\
     % $R^2$ & 0.424 & 0.585 & 0.707 & 0.694 & 0.471 & 0.350 \\
     Adjusted $R^2$ & 0.406 & 0.567 & 0.240 & 0.283 & 0.454 & 0.322 \\
    \hline
    \hline \\[-1.8ex]
    \end{tabular}
    \begin{tablenotes}
...
\begin{frame}{Descriptive Stats: Profits and Efficiency}
    ...
    \hline
    \hline \\[-1.8ex]
     Realized Surplus (\% of CE)          & 84.3      & 81.81     & 79.76     & 77.31     & 88.85     & 86.31     \\
     Realized Surplus (buy-sell)(\%) & 53.7      & 11.18     & 27.38     & -5.16     & 80.03     & 27.51     \\
     Excess profit (buy-sell)        & 2537     & 929           & 1656     & 523           & 3417      & 1335          \\
     % \hspace{3mm}\textit{Sellers}            & 95       & 105      & 78        & 101       & 86       & 103      \\
     % \hspace{3mm}\textit{Buyers}             & 122      & 100      & 158       & 129       & 140      & 114      \\
     % Realized Surplus (\%) (sum over sum)  & 79.86     & 77.22     & 88.8      & 86.15     & 84.33     & 81.68     \\
     % Sellers                       & 65.22     & 72.42     & 58.92     & 74.38     & 62.07     & 73.4      \\
     % Buyers                         & 94.2      & 81.91     & 118.07    & 97.68     & 106.13    & 89.8      \\
    \hline
    \hline 
    \end{tabular}
    % \begin{tablenotes}
...
\begin{table}[!htbp]
   ...
   %\caption{Regression Summary}
    ...
    \\[-1.8ex]\hline
    \hline \\[-1.8ex]
    & \multicolumn{2}{c}{filled CE quantity} & \multicolumn{2}{c}{realized surplus} & \multicolumn{2}{c}{excess profits$_{buy-sell}$}\\
    & \cline{1-6}
    & (1) & (2) & (3) & (4) & (5) & (6) \\
    & T1-T20 & T11-T20 & T1-T20 & T11-T20 & T1-T20 & T11-T20 \\
    \hline \\[-1.8ex]
     Intercept & 0.634$^{***}$ & 0.641$^{***}$ & 0.521$^{***}$ & 0.627$^{***}$ & 10327$^{***}$ & 14453$^{***}$ \\
      & (0.117) & (0.122) & (0.109) & (0.138) & (1809) & (2834) \\
     FLOW & -0.080$^{*}$ & -0.048$^{}$ & -0.025$^{}$ & -0.025$^{}$ & -1608$^{}$ & -2082$^{*}$ \\
      & (0.044) & (0.034) & (0.035) & (0.030)  & (1113) & (1072) \\
     round & 0.016$^{***}$ & 0.014$^{**}$ & 0.020$^{***}$ & 0.014$^{**}$  & -92$^{}$ & -302$^{*}$ \\
      & (0.005) & (0.006) & (0.005) & (0.007) & (107) & (174) \\
    \hline \\[-1.8ex]
     CDA mean & 85.2 & 89.3 & 84.3 & 88.85 & 2537 & 3417 \\
     Observations & 200 & 100 & 200 & 100 & 200 & 100 \\
     Adjusted $R^2$ & 0.264 & 0.150 & 0.291 & 0.052 & 0.779 & 0.805 \\
    \hline
    \hline \\[-1.8ex]
    \end{tabular}
    \begin{tablenotes}
...
\begin{itemize}
\item The significantly lower trading volume in Flow format does not greatly impair filling contracts; treatment effect is insignificant. %\pause
...
\item Performance metrics for prices, quantities and surplus. 
...
\item Price insignificantly closer to CE overall and in last half. %\pause
\item Price changes and volatility much less in Flow, even in first half.  %\pause
